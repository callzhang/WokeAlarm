...
extern const struct EWMediaFetchedProperties {
} EWMediaFetchedProperties;
...
@interface EWMediaID : NSManagedObjectID {}
@end
...
@interface _EWMedia (CoreDataGeneratedAccessors)
