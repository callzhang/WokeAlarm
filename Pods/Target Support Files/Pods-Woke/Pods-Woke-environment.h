...
// TMKit
#define COCOAPODS_POD_AVAILABLE_TMKit
#define COCOAPODS_VERSION_MAJOR_TMKit 0
#define COCOAPODS_VERSION_MINOR_TMKit 1
#define COCOAPODS_VERSION_PATCH_TMKit 0
