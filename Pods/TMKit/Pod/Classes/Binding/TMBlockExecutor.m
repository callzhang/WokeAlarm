...
@interface TMBlockExecutor()
@property (nonatomic, readonly, copy) id block;
@end

@implementation TMBlockExecutor
...
+ (id)invokeBlock:(id)block withArguments:(TMTuple *)arguments {
    ...
    TMBlockExecutor *executor = [[self alloc] initWithBlock:block];
    return [executor invokeWithArguments:arguments];
}

- (id)invokeWithArguments:(TMTuple *)arguments {
...
+ (void)invokeNoReturnBlock:(id)block withArguments:(TMTuple *)arguments {
    ...
    TMBlockExecutor *executor = [[self alloc] initWithBlock:block];
    [executor invokeNoReturnWithArguments:arguments];
}

- (void)invokeNoReturnWithArguments:(TMTuple *)arguments {
    SEL selector = [self selectorWithNoReturnForArgumentCount:arguments.count];
    NSInvocation *invocation = [NSInvocation invocationWithMethodSignature:[self methodSignatureForSelector:selector]];
    invocation.selector = selector;
    invocation.target = self;
...
- (SEL)selectorWithNoReturnForArgumentCount:(NSUInteger)count {
    NSCParameterAssert(count > 0);

    switch (count) {
        case 0: return NULL;
        case 1: return @selector(performNoReturnWith:);
        case 2: return @selector(performNoReturnWith::);
        case 3: return @selector(performNoReturnWith:::);
        case 4: return @selector(performNoReturnWith::::);
        case 5: return @selector(performNoReturnWith:::::);
        case 6: return @selector(performNoReturnWith::::::);
        case 7: return @selector(performNoReturnWith:::::::);
        case 8: return @selector(performNoReturnWith::::::::);
        case 9: return @selector(performNoReturnWith:::::::::);
        case 10: return @selector(performNoReturnWith::::::::::);
        case 11: return @selector(performNoReturnWith:::::::::::);
        case 12: return @selector(performNoReturnWith::::::::::::);
        case 13: return @selector(performNoReturnWith:::::::::::::);
        case 14: return @selector(performNoReturnWith::::::::::::::);
        case 15: return @selector(performNoReturnWith:::::::::::::::);
    }
...
- (void)performNoReturnWith:(id)obj1 {
    void (^block)(id) = self.block;
    block(obj1);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 {
    void (^block)(id, id) = self.block;
    block(obj1, obj2);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 {
    void (^block)(id, id, id) = self.block;
    block(obj1, obj2, obj3);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 {
    void (^block)(id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 {
    void (^block)(id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 {
    void (^block)(id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 {
    void (^block)(id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 {
    void (^block)(id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 {
    void (^block)(id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 {
    void (^block)(id, id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 :(id)obj11 {
    void (^block)(id, id, id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 :(id)obj11 :(id)obj12 {
    void (^block)(id, id, id, id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 :(id)obj11 :(id)obj12 :(id)obj13 {
    void (^block)(id, id, id, id, id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 :(id)obj11 :(id)obj12 :(id)obj13 :(id)obj14 {
    void (^block)(id, id, id, id, id, id, id, id, id, id, id, id, id, id) = self.block;
    block(obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13, obj14);
}

- (void)performNoReturnWith:(id)obj1 :(id)obj2 :(id)obj3 :(id)obj4 :(id)obj5 :(id)obj6 :(id)obj7 :(id)obj8 :(id)obj9 :(id)obj10 :(id)obj11 :(id)obj12 :(id)obj13 :(id)obj14 :(id)obj15 {
    void (^block)(id, id, id, id, id, id, id, id, id, id, id, id, id, id, id) = self.block;
